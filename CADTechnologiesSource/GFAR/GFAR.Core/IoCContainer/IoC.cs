...
namespace GFAR.Core.IoCContainer
{
    /// <summary>
    ...
    public static class IoC
    {
        ...
        /// </summary>
        private static void BindGFARViewModels()
        {
            if (issetup == false)
                // Bind to a single instance of the application view model
                Kernal.Bind<GFAR.Core.ViewModels.MainWindow_GFAR_ViewModel>().ToConstant(new GFAR.Core.ViewModels.MainWindow_GFAR_ViewModel());
            issetup = true;
        }
