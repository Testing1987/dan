...
namespace Alignment_mdi
{
    class Coord_conv
    {
        ...
        public static string build_KML_string(string kml_name, string kml_line_style, System.Data.DataTable dt1, System.Data.DataTable dt3)
        {
            string q = "\u0022";
            ...
            {
                extend_data = get_extended_data_schema("name1", "Test1", dt3) + "\r\n";
            }
        ...
        public static string get_extended_data_schema(string schema_name, string schemaid, System.Data.DataTable dt1)
        {
            string q = "\u0022";
            string extended_data = "	<Schema name=" + q + schema_name + q + " id=" + q + schemaid + q + ">";

            for (int j = 0; j < dt1.Columns.Count; ++j)
            {
                System.Type data_type1 = dt1.Columns[j].DataType;
                string kml_type = "string";

                // if (data_type1 == typeof(double)) kml_type = "double";

                extended_data = extended_data +
                    "\r\n		<SimpleField type=" + q + kml_type + q + " name=" + q + dt1.Columns[j].ColumnName + q + "><displayName>&lt;b&gt;" + dt1.Columns[j].ColumnName + "&lt;/b&gt;</displayName>" +
                    "\r\n</SimpleField>";
        ...
        public static string set_extend_data_values(string schemaid, System.Data.DataTable dt1, int i)
        {
            string q = "\u0022";
            ...
            {
                extended_data = "			<ExtendedData>" + "\r\n" + "				<SchemaData schemaUrl=" + q + schemaid + q + ">";
                ...
                for (int j = 0; j < dt1.Columns.Count; ++j)
                {
                    ...
                    extended_data = extended_data + "\r\n					<SimpleData name=" + q + dt1.Columns[j].ColumnName + q + ">" + val1 + "</SimpleData>";
                }
        ...
        public static string get_kml_line_placemark(string placemark_name, string style_map_name, string coords, string nume_extended, System.Data.DataTable dt3, System.Data.DataTable dt_mat_library)
        {
            ...
            {
                extend_data = set_extend_data_values(nume_extended, dt3, 0) + "\r\n";

                if (dt3.Columns.Contains("ItemNo") == true)
                {
                    for (int i = 0; i < dt3.Rows.Count; ++i)
                    {
                        if (dt3.Rows[i]["ItemNo"] != DBNull.Value)
                        {
                            item1 = Convert.ToString(dt3.Rows[i]["ItemNo"]);
                        }
                    }
                }
            }
            ...
            {
                if (dt_mat_library.Columns.Contains("ItemNo") == true && dt_mat_library.Columns.Contains("Descr") == true)
                {
                    for (int i = 0; i < dt_mat_library.Rows.Count; ++i)
                    {
                        if (dt_mat_library.Rows[i]["ItemNo"] != DBNull.Value)
                        {
                            string item2 = Convert.ToString(dt_mat_library.Rows[i]["ItemNo"]);
                            if(item1==item2)
                            {
                                string descr2 = Convert.ToString(dt_mat_library.Rows[i]["Descr"]);

                                placemark_name = descr2;
        ...
        public static string get_kml_point_placemark(string placemark_name, string coord, string nume_extended, System.Data.DataTable dt3, System.Data.DataTable dt_mat_library)
        {
            ...
            string line2 = "			<name>" + placemark_name + "</name>";
            string line3 = "			<Point>";
            string line4 = "				<coordinates>";
            string line5 = coord;
            string line6 = "				</coordinates>";
            string line7 = "			</Point>";
            string line8 = "		</Placemark>";
            string final_string = line1 + "\r\n" + line2 + "\r\n" + extend_data + line3 + "\r\n" + line4 + "\r\n" + line5 + "\r\n" +
                                  line6 + "\r\n" + line7 + "\r\n" + line8 + "\r\n";
