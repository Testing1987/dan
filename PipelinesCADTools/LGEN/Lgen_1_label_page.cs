...
namespace Alignment_mdi
{
    public partial class Lgen_label_page : Form
    {
        ...
        Autodesk.Gis.Map.Project.DrawingSet drawingset1 = null;

        Autodesk.Gis.Map.Project.ProjectModel project1 = null;
        List<string> lista_xref = null;
        ...
        private void set_enable_false()
        {
            ...
            lista_butoane.Add(button_brd_mleader);
            lista_butoane.Add(button_corner_tie);
            lista_butoane.Add(Button_create_label);
            lista_butoane.Add(button_label_easement);
            lista_butoane.Add(button_mleader_ne);
            lista_butoane.Add(Button_SetRotation);
            lista_butoane.Add(button_x_y);


            lista_butoane.Add(comboBox_ms_ps);
            lista_butoane.Add(Combobox_scales);
            lista_butoane.Add(comboBox_prefix_x_y);
            lista_butoane.Add(button_map_attach);
            lista_butoane.Add(button_detach);
        ...
        private void Lgen_label_page_load(object sender, EventArgs e)
        {
            ...
            Lg = this.MdiParent as Lgen_mainform;
            if (Functions.is_dan_popescu() == true)
            {
                Lgen_mainform.ExcelVisible = true;
            }
        ...
        {
            if (Lgen_mainform.dt_alias == null || Lgen_mainform.dt_alias.Rows.Count == 0)
            {
                ...
                using (DocumentLock lock1 = ThisDrawing.LockDocument())
                {
                    ...
                    select0:
                        ...
                        if (curve1 != null)
                        {
                            ...
                            if (Lgen_mainform.lista_layere.Contains(layer_curba) == true)
                            {
                                ...
                                idx_alias = Lgen_mainform.lista_layere.IndexOf(layer_curba);
                                ...
                                label_info2.Text = "Selected: " + layer_curba;
                                ...
                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_desc] != DBNull.Value)
                                {
                                    gen_description = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_desc]);
                                }

                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_lay] != DBNull.Value)
                                {
                                    layer_name_specified_in_table = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_lay]);
                                }
                                ...
                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_bdy] != DBNull.Value)
                                {
                                    string bdy = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_bdy]);
                                ...
                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_align] != DBNull.Value)
                                {
                                    string align1 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_align]);
                                ...
                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_prim] != DBNull.Value)
                                {
                                    string label_val = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_prim]);
                                ...
                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_sec] != DBNull.Value)
                                {
                                    string label_val = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_sec]);
                                    if (label_val.ToLower() == "mtext")
                                    {
                                ...
                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_ter] != DBNull.Value)
                                {
                                    string label_val = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_ter]);
                                    if (label_val.ToLower() == "mtext")
                                    {
                                ...
                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_tst] != DBNull.Value)
                                {
                                    table_txt_stylename = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_tst]);
                                }
                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_tf] != DBNull.Value)
                                {
                                    table_txt_fontname = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_tf]);
                                }
                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_tw] != DBNull.Value)
                                {
                                    string val1 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_tw]);
                                ...
                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_to] != DBNull.Value)
                                {
                                    string val1 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_to]);
                                    if (Functions.IsNumeric(val1) == true)
                                    {
                                ...
                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_th] != DBNull.Value)
                                {
                                    string val1 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_th]);
                                    if (Functions.IsNumeric(val1) == true)
                                    {
                                ...
                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_tu] != DBNull.Value)
                                {
                                    string val1 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_tu]);
                                ...
                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_bm] != DBNull.Value)
                                {
                                    string val1 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_bm]);
                                    if (val1.ToLower() == "yes" || val1.ToLower() == "true")
                                    {
                                ...
                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_mst] != DBNull.Value)
                                {
                                    table_mstyle_name = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_mst]) + "_" + scale1.ToString();
                                }

                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_ma] != DBNull.Value)
                                {
                                    string val1 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_ma]);
                                    if (Functions.IsNumeric(val1) == true)
                                    {
                                ...
                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_mg] != DBNull.Value)
                                {
                                    string val1 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_mg]);
                                    if (Functions.IsNumeric(val1) == true)
                                    {
                                ...
                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_md] != DBNull.Value)
                                {
                                    string val1 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_md]);
                                    if (Functions.IsNumeric(val1) == true)
                                    {
                                ...
                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_nh] != DBNull.Value)
                                {
                                    string val1 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_nh]);
                                    if (Functions.IsNumeric(val1) == true)
                                    {
                                ...
                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_txtf] != DBNull.Value)
                                {
                                    string val1 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_txtf]);
                                    if (val1.ToLower() == "yes" || val1.ToLower() == "true")
                                    {
                                ...
                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_od] != DBNull.Value)
                                {
                                    string val1 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_od]);
                                    if (val1.ToLower() == "yes" || val1.ToLower() == "true")
                                    {
                                        is_object_data = true;
                                        este_od = "OD:Yes";
                                ...
                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_c] != DBNull.Value)
                                {
                                    string val1 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_c]);
                                    if (val1.ToLower() == "yes" || val1.ToLower() == "true")
                                    {
                                        is_capitalized = true;
                                        upp = "Upper";
                                ...
                                label_info1.Text = este_bdy + ", " + algn + ", " + este_od + ", " + sep + ", " + upp;



                                #region countour data
                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_cl] != DBNull.Value)
                                {
                                    string val1 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_cl]);
                                    if (val1.ToLower() == "yes")
                                    {
                                        is_contour = true;
                                    }
                                ...
                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_clp] != DBNull.Value)
                                {
                                    string val1 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_clp]);
                                    if (Functions.IsNumeric(val1) == true)
                                    {
                                ...
                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_p1] != DBNull.Value)
                                {
                                    p1 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_p1]);
                                }
                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_od1] != DBNull.Value)
                                {
                                    f1 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_od1]);
                                }
                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_s1] != DBNull.Value)
                                {
                                    s1 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_s1]);
                                }

                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_p2] != DBNull.Value)
                                {
                                    p2 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_p2]);
                                }
                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_od2] != DBNull.Value)
                                {
                                    f2 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_od2]);
                                }
                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_s2] != DBNull.Value)
                                {
                                    s2 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_s2]);
                                }

                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_p3] != DBNull.Value)
                                {
                                    p3 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_p3]);
                                }
                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_od3] != DBNull.Value)
                                {
                                    f3 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_od3]);
                                }
                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_s3] != DBNull.Value)
                                {
                                    s3 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_s3]);
                                }

                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_p4] != DBNull.Value)
                                {
                                    p4 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_p4]);
                                }
                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_od4] != DBNull.Value)
                                {
                                    f4 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_od4]);
                                }
                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_s4] != DBNull.Value)
                                {
                                    s4 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_s4]);
                                }

                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_p5] != DBNull.Value)
                                {
                                    p5 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_p5]);
                                }
                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_od5] != DBNull.Value)
                                {
                                    f5 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_od5]);
                                }
                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_s5] != DBNull.Value)
                                {
                                    s5 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_s5]);
                                }

                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_p6] != DBNull.Value)
                                {
                                    p6 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_p6]);
                                }
                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_od6] != DBNull.Value)
                                {
                                    f6 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_od6]);
                                }
                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_s6] != DBNull.Value)
                                {
                                    s6 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_s6]);
                                }

                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_p7] != DBNull.Value)
                                {
                                    p7 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_p7]);
                                }
                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_od7] != DBNull.Value)
                                {
                                    f7 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_od7]);
                                }
                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_s7] != DBNull.Value)
                                {
                                    s7 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_s7]);
                                }

                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_p8] != DBNull.Value)
                                {
                                    p8 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_p8]);
                                }
                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_od8] != DBNull.Value)
                                {
                                    f8 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_od8]);
                                }
                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_s8] != DBNull.Value)
                                {
                                    s8 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_s8]);
                                }

                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_p9] != DBNull.Value)
                                {
                                    p9 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_p9]);
                                }
                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_od9] != DBNull.Value)
                                {
                                    f9 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_od9]);
                                }
                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_s9] != DBNull.Value)
                                {
                                    s9 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_s9]);
                                }

                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_p10] != DBNull.Value)
                                {
                                    p10 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_p10]);
                                }
                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_od10] != DBNull.Value)
                                {
                                    f10 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_od10]);
                                }
                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_s10] != DBNull.Value)
                                {
                                    s10 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_s10]);
                                }
                                #endregion
                                ...
                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_bn] != DBNull.Value)
                                {
                                    table_bl_name = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_bn]);
                                }
                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_bac] != DBNull.Value)
                                {
                                    table_atr_c = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_bac]);
                                }

                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_ba1] != DBNull.Value)
                                {
                                    table_atr_1 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_ba1]);
                                }

                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_ba2] != DBNull.Value)
                                {
                                    table_atr_2 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_ba2]);
                                }

                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_ba3] != DBNull.Value)
                                {
                                    table_atr_3 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_ba3]);
                                }

                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_ba4] != DBNull.Value)
                                {
                                    table_atr_4 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_ba4]);
                                }

                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_ba5] != DBNull.Value)
                                {
                                    table_atr_5 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_ba5]);
                                }

                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_ba6] != DBNull.Value)
                                {
                                    table_atr_6 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_ba6]);
                                }

                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_ba7] != DBNull.Value)
                                {
                                    table_atr_7 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_ba7]);
                                }

                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_ba8] != DBNull.Value)
                                {
                                    table_atr_8 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_ba8]);
                                }

                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_ba9] != DBNull.Value)
                                {
                                    table_atr_9 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_ba9]);
                                }

                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_ba10] != DBNull.Value)
                                {
                                    table_atr_10 = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_ba10]);
                                }
                                #endregion

                                #region dimstyle param
                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_d_sty] != DBNull.Value)
                                {
                                    table_dimstyle_name = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_d_sty]);
                                    table_dimstyle_name = table_dimstyle_name + "_" + scale1.ToString();
                                }

                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_d_arr] != DBNull.Value)
                                {
                                    string valtxt = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_d_arr]);
                                    if (Functions.IsNumeric(valtxt) == true)
                                    {
                                        table_dim_arrow_size = Convert.ToDouble(Lgen_mainform.dt_alias.Rows[idx_alias][i_d_arr]);
                                    }
                                }
                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_d_suff] != DBNull.Value)
                                {
                                    table_dimstyle_suffix = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_d_suff]);
                                }

                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_d_decno] != DBNull.Value)
                                {
                                    string valtxt = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_d_decno]);
                                    if (Functions.IsNumeric(valtxt) == true)
                                    {
                                        table_dimstyle_dec_no = Convert.ToInt32(Lgen_mainform.dt_alias.Rows[idx_alias][i_d_decno]);
                                    }
                                }

                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_d_round_closest] != DBNull.Value)
                                {
                                    string valtxt = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_d_round_closest]);
                                    if (Functions.IsNumeric(valtxt) == true)
                                    {
                                        table_dimstyle_round_closest = Convert.ToInt32(Lgen_mainform.dt_alias.Rows[idx_alias][i_d_round_closest]);
                                    }
                                }

                                if (Lgen_mainform.dt_alias.Rows[idx_alias][i_force_dim] != DBNull.Value)
                                {
                                    string valtxt = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_force_dim]);
        ...
        static ObjectId GetArrowObjectId(string new_arrow)
        {
        ...
        private void Button_pick_Rotation_Click(object sender, EventArgs e)
        {
            ...
            {
                set_enable_false();
                Lg.WindowState = FormWindowState.Minimized;
        ...
        public void label_excel_file_red()
        {
            label_excel_file.Text = "Not loaded";
            label_excel_file.ForeColor = Color.OrangeRed;

        }

        public void label_excel_file_green()
        {
            label_excel_file.Text = System.IO.Path.GetFileName(Lgen_mainform.Fisier_layer_alias);
        ...
        private void button_brd_mleader_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                using (Autodesk.AutoCAD.ApplicationServices.DocumentLock Lock1 = ThisDrawing.LockDocument())
                {
                    ...
                    using (Autodesk.AutoCAD.DatabaseServices.Transaction Trans1 = ThisDrawing.TransactionManager.StartTransaction())
                    {
                        if (comboBox_ms_ps.Text == "Paper Space")
                        {
                    ...
                    for (int i = 0; i < Lgen_mainform.dt_alias.Rows.Count; ++i)
                    {
                        if (Lgen_mainform.dt_alias.Rows[i][0] != DBNull.Value && Convert.ToString(Lgen_mainform.dt_alias.Rows[i][0]).ToUpper() == "B AND D SETTINGS")
                        {
                            if (Lgen_mainform.dt_alias.Rows[i][i_round] != DBNull.Value && Functions.IsNumeric(Convert.ToString(Lgen_mainform.dt_alias.Rows[i][i_round])) == true)
                            {
                                round1 = Convert.ToInt32(Lgen_mainform.dt_alias.Rows[i][i_round]);
                            }
                            idx_alias = i;
                            i = Lgen_mainform.dt_alias.Rows.Count;
                    ...
                    if (Lgen_mainform.dt_alias.Rows[idx_alias][i_lay] != DBNull.Value && Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_lay]).Replace(" ", "").Length > 0)
                    {
                        label_layer = Convert.ToString(Lgen_mainform.dt_alias.Rows[idx_alias][i_lay]);
                    }
                    else
                    {
        ...
        private void button_x_y_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                using (Autodesk.AutoCAD.ApplicationServices.DocumentLock Lock1 = ThisDrawing.LockDocument())
                {
                    ...
                    for (int i = 0; i < Lgen_mainform.dt_alias.Rows.Count; ++i)
                    {
                        if (Lgen_mainform.dt_alias.Rows[i][0] != DBNull.Value && Convert.ToString(Lgen_mainform.dt_alias.Rows[i][0]).ToUpper() == "X AND Y SETTINGS")
                        {
                            if (Lgen_mainform.dt_alias.Rows[i][i_round] != DBNull.Value && Functions.IsNumeric(Convert.ToString(Lgen_mainform.dt_alias.Rows[i][i_round])) == true)
                            {
                                round1 = Convert.ToInt32(Lgen_mainform.dt_alias.Rows[i][i_round]);
                    ...
                    if (idx_alias == -1)
                    {
                        MessageBox.Show("NO <X and Y settings> specified\r\nYou have to specify Mtext style and Mleader style");
                        set_enable_true();
                        return;
                    }
                ...
                l123:
                    ...
                    using (Autodesk.AutoCAD.DatabaseServices.Transaction Trans1 = ThisDrawing.TransactionManager.StartTransaction())
                    {
                        ...
                        Autodesk.AutoCAD.EditorInput.PromptPointResult Point_res1;
                        Autodesk.AutoCAD.EditorInput.PromptPointOptions PP1;
                        PP1 = new Autodesk.AutoCAD.EditorInput.PromptPointOptions("\nPlease specify the required point");
                        PP1.AllowNone = false;
                        Point_res1 = Editor1.GetPoint(PP1);
                        ...
                        string first_line = comboBox_prefix_x_y.Text;
                        if (first_line.Replace(" ", "") != "")
                        {
                            first_line = first_line + "\\P";
                        }

                        Content1 = first_line + "X = " + Functions.Get_String_Rounded_with_thousand_sep(x1, round1) + "'\\PY = " + Functions.Get_String_Rounded_with_thousand_sep(y1, round1) + "'";

                        if (first_line.ToUpper() == "CUSTOM\\P")
                        {
                            Content1 = textBox_custom.Text;
                            if (Content1 == "")
                            {
                                MessageBox.Show("Nothing specified into the custom text box");
                            }
                        }
                        ...
                        if (Content1 != "")
                        {
                            ...
                            double Bearingml = Functions.GET_Bearing_rad(Point1.X, Point1.Y, Point4.X, Point4.Y) * 180 / Math.PI;
                            if (Bearingml >= 360)
                            {
                                do
                                {
        ...
        private void button_label_workspace_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                using (Autodesk.AutoCAD.ApplicationServices.DocumentLock Lock1 = ThisDrawing.LockDocument())
                {
                    ...
                    for (int i = 0; i < Lgen_mainform.dt_alias.Rows.Count; ++i)
                    {
                        if (Lgen_mainform.dt_alias.Rows[i][0] != DBNull.Value && Convert.ToString(Lgen_mainform.dt_alias.Rows[i][0]).ToUpper() == "LABEL WORKSPACE SETTINGS")
                        {
                            if (Lgen_mainform.dt_alias.Rows[i][i_round] != DBNull.Value && Functions.IsNumeric(Convert.ToString(Lgen_mainform.dt_alias.Rows[i][i_round])) == true)
                            {
                                round1 = Convert.ToInt32(Lgen_mainform.dt_alias.Rows[i][i_round]);
        ...
        private void comboBox_prefix_x_y_SelectedIndexChanged(object sender, EventArgs e)
        {
            if (comboBox_prefix_x_y.Text.ToUpper() == "CUSTOM")
            {
                this.MdiParent.Size = new Size(678, 302);
                this.Size = new Size(678, 243);
                panel7.Size = new Size(304, 215);
                panel11.Size = new Size(304, 25);
            }
            else
            {
                this.MdiParent.Size = new Size(531, 302);
                this.Size = new Size(531, 243);
                panel7.Size = new Size(157, 215);
                panel11.Size = new Size(157, 25);
            }
        }

        private void button_corner_tie_Click(object sender, EventArgs e)
        {
            ObjectId[] Empty_array = null;
            int round1 = 1;
            set_enable_false();
            ...
            try
            {
                ...
                using (Autodesk.AutoCAD.ApplicationServices.DocumentLock Lock1 = ThisDrawing.LockDocument())
                {
                    ...
                    for (int i = 0; i < Lgen_mainform.dt_alias.Rows.Count; ++i)
                    {
                        if (Lgen_mainform.dt_alias.Rows[i][0] != DBNull.Value && Convert.ToString(Lgen_mainform.dt_alias.Rows[i][0]).ToUpper() == "CORNER TIE SETTINGS")
                        {
                            if (Lgen_mainform.dt_alias.Rows[i][i_round] != DBNull.Value && Functions.IsNumeric(Convert.ToString(Lgen_mainform.dt_alias.Rows[i][i_round])) == true)
                            {
                                round1 = Convert.ToInt32(Lgen_mainform.dt_alias.Rows[i][i_round]);
                    ...
                    if (idx_alias == -1)
                    {
                        MessageBox.Show("NO <Corner Tie settings> specified\r\nYou have to specify the number of decimals on column BU");
                        set_enable_true();
                        return;
                    }
                    ...
                    {
                        label_layer = "_Lgen_corner_tie_" + scale1.ToString();
                    }
                ...
                l123:
                    ...
                    using (Autodesk.AutoCAD.DatabaseServices.Transaction Trans1 = ThisDrawing.TransactionManager.StartTransaction())
                    {
                        ...
                        double Stretch1 = Math.Pow(Math.Pow(x1 - x2, 2) + Math.Pow(y1 - y2, 2), 0.5);
                        Point3d Inspt = Point1;
                        ...
                        string Quadrant1 = Functions.Get_Quadrant_bearing(Bearing1);
                        string Distance = Functions.Get_String_Rounded_with_thousand_sep(Dist1, round1) + "'";
                        string Content1 = Quadrant1 + "\\P" + Distance;
                        Content1 = Content1.Replace(" ", "");
                        if (rot1 > Math.PI / 2 && rot1 < 3 * Math.PI / 2)
                        {
                            rot1 = rot1 + Math.PI;
                            Inspt = Point2;
                            //Content1 =Distance  + "\\P" +Quadrant1 ;
                        }
                        ...
                        BlockReference BR1 = Functions.InsertBlock_with_multiple_atributes_with_database(ThisDrawing.Database, BTrecord, "G:\\_HMM\\Design\\Programming\\DLL\\Others\\CornerTie.dwg", "CornerTie", Inspt, scale1, rot1, label_layer, col_atr, col_val);
                        Functions.Stretch_block(BR1, "Distance1", Stretch1);
        ...
        {
            if (System.IO.File.Exists(Lgen_mainform.Fisier_layer_alias) == true) Lgen_mainform.dt_alias = Lgen_mainform.Load_existing_Lgen_layer_alias_from_excel(Lgen_mainform.Fisier_layer_alias);
        }

        private void button_detach_Click(object sender, EventArgs e)
        {
            if (lista_xref == null || lista_xref.Count == 0)
            {
                MessageBox.Show("nothing was map detached");
                return;
            }
            ...
            try
            {
                ...
                using (DocumentLock lock1 = ThisDrawing.LockDocument())
                {
                    using (Autodesk.AutoCAD.DatabaseServices.Transaction Trans1 = ThisDrawing.TransactionManager.StartTransaction())
                    {
                        ...
                        project1 = Autodesk.Gis.Map.HostMapApplicationServices.Application.ActiveProject;
                        drawingset1 = project1.DrawingSet;

                        try
                        {
                            while (drawingset1.DirectDrawingsCount > 0)
                            {
                                drawingset1.DetachDrawing(0);
                            }
                        }
                        catch (Autodesk.Gis.Map.MapException mapex)
                        {

                            MessageBox.Show(mapex.Message);
                        }
        ...
        private void button_map_attach_Click(object sender, EventArgs e)
        {
            if (Lgen_mainform.dt_alias == null || Lgen_mainform.dt_alias.Rows.Count == 0)
            {
                MessageBox.Show("no layer alias loaded\r\noperation aborted");
            ...
            try
            {
                ...
                using (DocumentLock lock1 = ThisDrawing.LockDocument())
                {
                    using (Autodesk.AutoCAD.DatabaseServices.Transaction Trans1 = ThisDrawing.TransactionManager.StartTransaction())
                    {
                        ...
                        Autodesk.AutoCAD.EditorInput.PromptNestedEntityResult Rezultat1;
                        Autodesk.AutoCAD.EditorInput.PromptNestedEntityOptions Prompt_sel_ent;
                        Prompt_sel_ent = new Autodesk.AutoCAD.EditorInput.PromptNestedEntityOptions("\nSelect the feature belonging to a XREF:");
        ...
        private void Button_create_labelR1_Click(object sender, EventArgs e)
        {
            if (Lgen_mainform.dt_alias == null || Lgen_mainform.dt_alias.Rows.Count == 0)
            {
                MessageBox.Show("no layer alias loaded\r\noperation aborted");
        ...
        public void SET_VARIABLES_NULL()
        {
            drawingset1 = null;
            project1 = null;
            lista_xref = null;
    ...
    class BlockJig : EntityJig
    {
        ...
        public BlockJig(Matrix3d ucs, Transaction tr, BlockReference br, Dictionary<ObjectId, ObjectId> atts) : base(br)
        {
            _ucs = ucs;
            _pos = br.Position;
            _atts = atts;
        ...
        protected override bool Update()
        {
            ...
            if (br.AttributeCollection.Count > 0)
            {
                ...
                {
                    var obj = Trans1.GetObject(id, OpenMode.ForRead);
                    ...
                    if (ar != null)
                    {
                        ...
                        var obj2 = Trans1.GetObject(defId, OpenMode.ForRead);
        ...
        protected override SamplerStatus Sampler(JigPrompts prompts)
        {
            ...
            if (_pos == ucsPt) return SamplerStatus.NoChange;
            _pos = ucsPt;
        ...
        public PromptStatus Run()
        {
            ...
            if (doc == null) return PromptStatus.Error;
    ...
    public class Commands
    {
        ...
        {
            var ThisDrawing = Autodesk.AutoCAD.ApplicationServices.Application.DocumentManager.MdiActiveDocument;
            var db = ThisDrawing.Database;
            var ed = ThisDrawing.Editor;
            var pso = new PromptStringOptions("\nEnter block name: ");
            var pr = ed.GetString(pso);
            if (pr.Status != PromptStatus.OK)
                return;
            using (var tr = ThisDrawing.TransactionManager.StartTransaction())
            {
                ...
                // Run the jig
                var jig = new BlockJig(ed.CurrentUserCoordinateSystem, tr, br, atts);
