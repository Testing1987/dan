...
namespace Alignment_mdi
{
    ...
    {
        static public void insert_block(ref BlockReference br, string bl_name, string layer1, Polyline poly1, double scale1)
        {
            Autodesk.AutoCAD.ApplicationServices.Document ThisDrawing = Autodesk.AutoCAD.ApplicationServices.Application.DocumentManager.MdiActiveDocument;
            using (Transaction Trans1 = ThisDrawing.Database.TransactionManager.StartTransaction())
            {
                ...
                br.Layer = layer1;
                br.ColorIndex = 256;
                br.ScaleFactors = new Scale3d(scale1, scale1, scale1);
