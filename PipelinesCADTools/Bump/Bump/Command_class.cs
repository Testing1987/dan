    ...
    public class Command_class
    {
        ...
        public void Show_bump_Form()
        {
            if (isSECURE() == true)
            {
                ...
                try
                {
                    bump_form forma2 = new bump_form();
                    Autodesk.AutoCAD.ApplicationServices.Application.ShowModelessDialog(forma2);
                    forma2.Location = new System.Drawing.Point((Screen.PrimaryScreen.WorkingArea.Width - forma2.Width) / 2, (Screen.PrimaryScreen.WorkingArea.Height - forma2.Height) / 2);
                }
        ...
        public static bool isSECURE()
        {
            ...
            switch (number_drive)
            {
                ...
                default:
                    try
                    {
                        string UserDNS = System.Environment.GetEnvironmentVariable("USERDNSDOMAIN");
