...
namespace Alignment_mdi
{
    class Functions
    {
        ...
        static string col_pnt = "PNT";
        static string col_y = "NORTHING";
        static string col_x = "EASTING";
        static string col_z = "ELEVATION";
        static string col_feat_code = "FEATURE_CODE";
        static string col_descr = "DESCRIPTION";
        static string col_sta_lin = "STATION_LINEAR";
        static string col_sta_ifc = "STATION_IFC";
        static string col_mm_bk = "MM_BK";
        static string col_wall_bk = "WALL_BK";
        static string col_pipe_bk = "PIPE_BK";
        static string col_heat_bk = "HEAT_BK";
        static string col_coat_bk = "COATING_BK";
        static string col_grade_bk = "GRADE_BK";
        static string col_mm_ahd = "MM_AHD";
        static string col_wall_ahd = "WALL_AHD";
        static string col_pipe_ahd = "PIPE_AHD";
        static string col_heat_ahd = "HEAT_AHD";
        static string col_coat_ahd = "COATING_AHD";
        static string col_grade_ahd = "GRADE_AHD";
        static string col_ng = "NG";
        static string col_ng_y = "NG_NORTHING";
        static string col_ng_x = "NG_EASTING";
        static string col_ng_z = "NG_ELEVATION";
        static string col_cover = "COVER";
        static string col_location = "LOCATION";
        static string col_file_name = "FILENAME";
        static string col_h_ang = "H_ANGLE";
        static string col_v_ang = "V_ANGLE";
        static string col_length_bk = "LENGTH BACK";
        static string col_length_ahd = "LENGTH AHEAD";
        static string col_manufacture_bk = "MANUFACTURER BACK";
        static string col_manufacture_ahd = "MANUFACTURER AHEAD";
        static string col_cross_name = "CROSSING_NAME";
        ...
        static public System.Data.DataTable Populate_data_table_from_excel(System.Data.DataTable dt1, Worksheet W1, int start_row,
            ...
            string checkColumn12, string checkColumn13, string checkColumn14, string checkColumn15,
            string checkColumn16, string checkColumn17, string checkColumn18, string checkColumn19,
            string checkColumn20, string checkColumn21, string checkColumn22, string checkColumn23,
            string checkColumn24, string checkColumn25, string checkColumn26,
            bool show_message)
        {
            if (W1 == null) return dt1;

            int max_limit = 150000;


            if (checkColumn1 != "")
            {
                Range range1 = W1.Range[checkColumn1 + start_row.ToString() + ":" + checkColumn1 + max_limit.ToString()];
                object[,] values2 = new object[max_limit, 1];
            ...
            if (checkColumn2 != "")
            {
                Range range2 = W1.Range[checkColumn2 + Convert.ToString(start_row + dt1.Rows.Count) + ":" + checkColumn2 + max_limit.ToString()];
                object[,] values3 = new object[max_limit, 1];
            ...
            if (checkColumn3 != "")
            {
                Range range3 = W1.Range[checkColumn3 + Convert.ToString(start_row + dt1.Rows.Count) + ":" + checkColumn3 + max_limit.ToString()];
                object[,] values3 = new object[max_limit, 1];
            ...
            if (checkColumn4 != "")
            {
                Range range4 = W1.Range[checkColumn4 + Convert.ToString(start_row + dt1.Rows.Count) + ":" + checkColumn4 + max_limit.ToString()];
                object[,] values4 = new object[max_limit, 1];
            ...
            if (checkColumn5 != "")
            {
                Range range5 = W1.Range[checkColumn5 + Convert.ToString(start_row + dt1.Rows.Count) + ":" + checkColumn5 + max_limit.ToString()];
                object[,] values5 = new object[max_limit, 1];
            ...
            if (checkColumn6 != "")
            {
                Range range6 = W1.Range[checkColumn6 + Convert.ToString(start_row + dt1.Rows.Count) + ":" + checkColumn6 + max_limit.ToString()];
                object[,] values6 = new object[max_limit, 1];
            ...
            if (checkColumn7 != "")
            {
                Range range7 = W1.Range[checkColumn7 + Convert.ToString(start_row + dt1.Rows.Count) + ":" + checkColumn7 + max_limit.ToString()];
                object[,] values7 = new object[max_limit, 1];
            ...
            if (checkColumn8 != "")
            {
                Range range8 = W1.Range[checkColumn8 + Convert.ToString(start_row + dt1.Rows.Count) + ":" + checkColumn8 + max_limit.ToString()];
                object[,] values8 = new object[max_limit, 1];
            ...
            if (checkColumn9 != "")
            {
                Range range9 = W1.Range[checkColumn9 + Convert.ToString(start_row + dt1.Rows.Count) + ":" + checkColumn9 + max_limit.ToString()];
                object[,] values9 = new object[max_limit, 1];
            ...
            if (checkColumn10 != "")
            {
                Range range10 = W1.Range[checkColumn10 + Convert.ToString(start_row + dt1.Rows.Count) + ":" + checkColumn10 + max_limit.ToString()];
                object[,] values10 = new object[max_limit, 1];
            ...
            if (checkColumn11 != "")
            {
                Range range11 = W1.Range[checkColumn11 + Convert.ToString(start_row + dt1.Rows.Count) + ":" + checkColumn11 + max_limit.ToString()];
                object[,] values11 = new object[max_limit, 1];
            ...
            if (checkColumn12 != "")
            {
                Range range12 = W1.Range[checkColumn12 + Convert.ToString(start_row + dt1.Rows.Count) + ":" + checkColumn12 + max_limit.ToString()];
                object[,] values12 = new object[max_limit, 1];
            ...
            if (checkColumn13 != "")
            {
                Range range13 = W1.Range[checkColumn13 + Convert.ToString(start_row + dt1.Rows.Count) + ":" + checkColumn13 + max_limit.ToString()];
                object[,] values13 = new object[max_limit, 1];
            ...
            if (checkColumn14 != "")
            {
                Range range14 = W1.Range[checkColumn14 + Convert.ToString(start_row + dt1.Rows.Count) + ":" + checkColumn14 + max_limit.ToString()];
                object[,] values14 = new object[max_limit, 1];
            ...
            if (checkColumn15 != "")
            {
                Range range15 = W1.Range[checkColumn15 + Convert.ToString(start_row + dt1.Rows.Count) + ":" + checkColumn15 + max_limit.ToString()];
                object[,] values15 = new object[max_limit, 1];
            ...
            if (checkColumn16 != "")
            {
                Range range16 = W1.Range[checkColumn16 + Convert.ToString(start_row + dt1.Rows.Count) + ":" + checkColumn16 + max_limit.ToString()];
                object[,] values16 = new object[max_limit, 1];
            ...
            if (checkColumn17 != "")
            {
                Range range17 = W1.Range[checkColumn17 + Convert.ToString(start_row + dt1.Rows.Count) + ":" + checkColumn17 + max_limit.ToString()];
                object[,] values17 = new object[max_limit, 1];
            ...
            if (checkColumn18 != "")
            {
                Range range18 = W1.Range[checkColumn18 + Convert.ToString(start_row + dt1.Rows.Count) + ":" + checkColumn18 + max_limit.ToString()];
                object[,] values18 = new object[max_limit, 1];
            ...
            if (checkColumn19 != "")
            {
                Range range19 = W1.Range[checkColumn19 + Convert.ToString(start_row + dt1.Rows.Count) + ":" + checkColumn19 + max_limit.ToString()];
                object[,] values19 = new object[max_limit, 1];
            ...
            if (checkColumn20 != "")
            {
                Range range20 = W1.Range[checkColumn20 + Convert.ToString(start_row + dt1.Rows.Count) + ":" + checkColumn20 + max_limit.ToString()];
                object[,] values20 = new object[max_limit, 1];
            ...
            if (checkColumn21 != "")
            {
                Range range21 = W1.Range[checkColumn21 + Convert.ToString(start_row + dt1.Rows.Count) + ":" + checkColumn21 + max_limit.ToString()];
                object[,] values21 = new object[max_limit, 1];
            ...
            if (checkColumn22 != "")
            {
                Range range22 = W1.Range[checkColumn22 + Convert.ToString(start_row + dt1.Rows.Count) + ":" + checkColumn22 + max_limit.ToString()];
                object[,] values22 = new object[max_limit, 1];
            ...
            if (checkColumn23 != "")
            {
                Range range23 = W1.Range[checkColumn23 + Convert.ToString(start_row + dt1.Rows.Count) + ":" + checkColumn23 + max_limit.ToString()];
                object[,] values23 = new object[max_limit, 1];
            ...
            if (checkColumn24 != "")
            {
                Range range24 = W1.Range[checkColumn24 + Convert.ToString(start_row + dt1.Rows.Count) + ":" + checkColumn24 + max_limit.ToString()];
                object[,] values24 = new object[max_limit, 1];
            ...
            if (checkColumn25 != "")
            {
                Range range25 = W1.Range[checkColumn25 + Convert.ToString(start_row + dt1.Rows.Count) + ":" + checkColumn25 + max_limit.ToString()];
                object[,] values25 = new object[max_limit, 1];
            ...
            if (checkColumn26 != "")
            {
                Range range26 = W1.Range[checkColumn26 + Convert.ToString(start_row + dt1.Rows.Count) + ":" + checkColumn26 + max_limit.ToString()];
                object[,] values26 = new object[max_limit, 1];
        ...
        public static System.Data.DataTable Creaza_weldmap_datatable_structure()
        {
            ...
            System.Data.DataTable dt = new System.Data.DataTable();
            dt.Columns.Add(col_pnt, typeof(string));
            dt.Columns.Add(col_y, typeof(string));
            dt.Columns.Add(col_x, typeof(string));
            dt.Columns.Add(col_z, typeof(string));
            dt.Columns.Add(col_feat_code, typeof(string));
            dt.Columns.Add(col_descr, typeof(string));
            dt.Columns.Add(col_sta_lin, typeof(string));
            dt.Columns.Add(col_sta_ifc, typeof(string));
            dt.Columns.Add(col_mm_bk, typeof(string));
            dt.Columns.Add(col_length_bk, typeof(string));
            dt.Columns.Add(col_wall_bk, typeof(string));
            dt.Columns.Add(col_pipe_bk, typeof(string));
            dt.Columns.Add(col_heat_bk, typeof(string));
            dt.Columns.Add(col_coat_bk, typeof(string));
            dt.Columns.Add(col_grade_bk, typeof(string));

            dt.Columns.Add(col_manufacture_bk, typeof(string));
            dt.Columns.Add(col_mm_ahd, typeof(string));
            dt.Columns.Add(col_length_ahd, typeof(string));

            dt.Columns.Add(col_wall_ahd, typeof(string));
            dt.Columns.Add(col_pipe_ahd, typeof(string));
            dt.Columns.Add(col_heat_ahd, typeof(string));
            dt.Columns.Add(col_coat_ahd, typeof(string));
            dt.Columns.Add(col_grade_ahd, typeof(string));
            dt.Columns.Add(col_manufacture_ahd, typeof(string));



            dt.Columns.Add(col_ng, typeof(string));
            dt.Columns.Add(col_ng_y, typeof(string));
            dt.Columns.Add(col_ng_x, typeof(string));
            dt.Columns.Add(col_ng_z, typeof(string));
            dt.Columns.Add(col_cover, typeof(string));
            dt.Columns.Add(col_location, typeof(string));
            dt.Columns.Add(col_file_name, typeof(string));
            dt.Columns.Add(col_h_ang, typeof(string));
            dt.Columns.Add(col_v_ang, typeof(string));
            dt.Columns.Add(col_cross_name, typeof(string));
        ...
        public static System.Data.DataTable Creaza_all_points_datatable_structure()
        {
            ...
            dt.Columns.Add("MISC8", typeof(string));//17
            dt.Columns.Add("MISC9", typeof(string));//18
            dt.Columns.Add("MISC10", typeof(string));//19
            dt.Columns.Add("MISC11", typeof(string));//20
            dt.Columns.Add("MISC12", typeof(string));//21
            dt.Columns.Add("MISC13", typeof(string));//22
            dt.Columns.Add("MISC14", typeof(string));//23
            dt.Columns.Add("MISC15", typeof(string));//24
            dt.Columns.Add("MISC16", typeof(string));//25
            dt.Columns.Add("MISC17", typeof(string));//26
