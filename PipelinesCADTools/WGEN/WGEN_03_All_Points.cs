    ...
    public partial class Wgen_all_pts : Form
    {
                    ...
                    if (filename.Length > 0 && sheet_name.Length > 0)
                    {
                        ...
                        if (W1 != null)
                        {
                            ...
                            if (dt1.Rows.Count > 0)
                            {
                                ...
                                string colGT_mmid = "MMID";
                                string colGT_pipe = "Pipe";
                                string colGT_heat = "Heat";
                                ...
                                var xray_duplicates = Wgen_main_form.dt_all_points.AsEnumerable().GroupBy(i => new { desc1 = i.Field<string>(col_xray), feat1 = i.Field<string>(col_fc) }).
                                ...
                                if (pt_duplicates.Count > 0 || xray_duplicates.Count > 0)
                                {
                                    ...
                                    for (int i = 0; i < Wgen_main_form.dt_all_points.Rows.Count; ++i)
                                    {
                                        ...
                                        if (xray_duplicates.Count > 0)
                                        {
                                            if (Wgen_main_form.dt_all_points.Rows[i][col_fc] != DBNull.Value &&
                                                (Convert.ToString(Wgen_main_form.dt_all_points.Rows[i][col_fc]).ToUpper() == "WELD" || Convert.ToString(Wgen_main_form.dt_all_points.Rows[i][col_fc]).ToUpper() == "WLD") &&
                                                Wgen_main_form.dt_all_points.Rows[i].GetChildRows(relation2).Length > 0)
                                            {
                                                if (Wgen_main_form.lista_feature_code_exception == null ||
                                                    ...
                                                    Wgen_main_form.lista_feature_code_exception.Contains(Convert.ToString(Wgen_main_form.dt_all_points.Rows[i][col_fc])) == false)
                                                {
                                ...
                                if (Wgen_main_form.dt_ground_tally != null && Wgen_main_form.dt_ground_tally.Rows.Count > 0)
                                {
                                    ...
                                    DataRelation relation_mm_back = new DataRelation("xxxY", Wgen_main_form.dt_all_points.Columns[col_mm_back], Wgen_main_form.dt_ground_tally.Columns[colGT_mmid], false);
                                    dataset1.Relations.Add(relation_mm_back);
                                    DataRelation relation_mm_ahead = new DataRelation("xxxZ", Wgen_main_form.dt_all_points.Columns[col_mm_ahead], Wgen_main_form.dt_ground_tally.Columns[colGT_mmid], false);
                                    dataset1.Relations.Add(relation_mm_ahead);
                                    ...
                                    for (int i = 0; i < Wgen_main_form.dt_all_points.Rows.Count; ++i)
                                    {
                                        ...
                                        if (Wgen_main_form.dt_all_points.Rows[i].GetChildRows(relation_mm_back).Length > 0)
                                        {
                                            if (Wgen_main_form.dt_all_points.Rows[i].GetChildRows(relation_mm_back)[0][colGT11] != DBNull.Value)
                                            {
                                                dj1 = Convert.ToString(Wgen_main_form.dt_all_points.Rows[i].GetChildRows(relation_mm_back)[0][colGT11]);
                                            }
                                        }
                                        ...
                                        if (Wgen_main_form.dt_all_points.Rows[i].GetChildRows(relation_mm_ahead).Length > 0)
                                        {
                                            if (Wgen_main_form.dt_all_points.Rows[i].GetChildRows(relation_mm_ahead)[0][colGT11] != DBNull.Value)
                                            {
                                                dj2 = Convert.ToString(Wgen_main_form.dt_all_points.Rows[i].GetChildRows(relation_mm_ahead)[0][colGT11]);
                                            }
                                        }
                                        ...
                                        if (Wgen_main_form.dt_all_points.Rows[i].GetChildRows(relation_mm_back).Length == 0 && mmid1.ToUpper() != "FAB")
                                        {


                                            if (Wgen_main_form.dt_all_points.Rows[i][col_fc] != DBNull.Value && Convert.ToString(Wgen_main_form.dt_all_points.Rows[i][col_fc]).ToUpper() == "WELD"
                                                || Wgen_main_form.dt_all_points.Rows[i][col_fc] != DBNull.Value && Convert.ToString(Wgen_main_form.dt_all_points.Rows[i][col_fc]).ToUpper() == "WLD")
                                            {
                                                if (Wgen_main_form.lista_feature_code_exception == null ||
                                                    Wgen_main_form.lista_feature_code_exception.Count == 0 ||
                                                    Wgen_main_form.lista_feature_code_exception.Contains(Convert.ToString(Wgen_main_form.dt_all_points.Rows[i][col_fc])) == false)
                                        ...
                                        if (Wgen_main_form.dt_all_points.Rows[i].GetChildRows(relation_mm_ahead).Length == 0 && mmid2.ToUpper() != "FAB")
                                        {
                                            if (Wgen_main_form.dt_all_points.Rows[i][col_fc] != DBNull.Value && Convert.ToString(Wgen_main_form.dt_all_points.Rows[i][col_fc]).ToUpper() == "WELD" ||
                                                Wgen_main_form.dt_all_points.Rows[i][col_fc] != DBNull.Value && Convert.ToString(Wgen_main_form.dt_all_points.Rows[i][col_fc]).ToUpper() == "WLD")
                                            {
                                        ...
                                        if (Wgen_main_form.client_name.ToUpper() == "WHITEWATER")
                                        {
                                            if (Wgen_main_form.dt_all_points.Rows[i].GetChildRows(relation_mm_ahead).Length > 0 && mmid2.ToUpper() != "FAB")
                                            {
                                                if (Wgen_main_form.dt_all_points.Rows[i][col_fc] != DBNull.Value && Convert.ToString(Wgen_main_form.dt_all_points.Rows[i][col_fc]).ToUpper() == "WELD" ||
                                                    Wgen_main_form.dt_all_points.Rows[i][col_fc] != DBNull.Value && Convert.ToString(Wgen_main_form.dt_all_points.Rows[i][col_fc]).ToUpper() == "WLD")
                                                {
                                                    if (Wgen_main_form.dt_all_points.Rows[i][col9] != DBNull.Value)
                                                    {

                                                        string heat_ahead_all_pt = Convert.ToString(Wgen_main_form.dt_all_points.Rows[i][col9]);
                                                        string heat_gt = "";
                                                        System.Data.DataRow row1 = Wgen_main_form.dt_all_points.Rows[i].GetChildRows(relation_mm_ahead)[0];
                                                        if (row1[colGT_heat] != DBNull.Value)
                                                        {
                                                            heat_gt = Convert.ToString(row1[colGT_heat]);
                                                        }

                                                        if (heat_gt.Replace(" ", "").ToUpper() != heat_ahead_all_pt.Replace(" ", "").ToUpper())
                                                        {
                                                            dt_errors.Rows.Add();
                                                            dt_errors.Rows[dt_errors.Rows.Count - 1]["Point"] = pt1;
                                                            dt_errors.Rows[dt_errors.Rows.Count - 1]["Value"] = heat_ahead_all_pt + " vs " + heat_gt;
                                                            dt_errors.Rows[dt_errors.Rows.Count - 1]["Excel"] = xl_mm_ahead + Convert.ToString(Convert.ToInt32(Wgen_main_form.dt_all_points.Rows[i]["index1"]) + start_row);
                                                            dt_errors.Rows[dt_errors.Rows.Count - 1]["w1"] = W1;
                                                            dt_errors.Rows[dt_errors.Rows.Count - 1]["Error"] = "Heat Ahead missmatch with Pipe Tally (whitewater)";
                                                            string x = "";
                                                            if (Wgen_main_form.dt_all_points.Rows[i][col3] != DBNull.Value)
                                                            {
                                                                x = Convert.ToString(Wgen_main_form.dt_all_points.Rows[i][col3]);
                                        ...
                                        if (Wgen_main_form.check_dj_against_xray == true && Wgen_main_form.dt_all_points.Rows[i][col8] != DBNull.Value && dj1 != "" && dj1 == dj2)
                                        {
                                            if (Wgen_main_form.dt_all_points.Rows[i][col_fc] != DBNull.Value && Convert.ToString(Wgen_main_form.dt_all_points.Rows[i][col_fc]).ToUpper() == "WELD" ||
                                                    Wgen_main_form.dt_all_points.Rows[i][col_fc] != DBNull.Value && Convert.ToString(Wgen_main_form.dt_all_points.Rows[i][col_fc]).ToUpper() == "WLD")
                                            {

                                                string xray1 = Convert.ToString(Wgen_main_form.dt_all_points.Rows[i][col8]);
                                                if (xray1 != dj1)
                                                {
                                                    dt_errors.Rows.Add();
                                                    dt_errors.Rows[dt_errors.Rows.Count - 1]["Point"] = pt1;
                                                    dt_errors.Rows[dt_errors.Rows.Count - 1]["Value"] = xray1 + " - " + dj1;
                                                    dt_errors.Rows[dt_errors.Rows.Count - 1]["Excel"] = xl_xray + Convert.ToString(Convert.ToInt32(Wgen_main_form.dt_all_points.Rows[i]["index1"]) + start_row);
                                                    dt_errors.Rows[dt_errors.Rows.Count - 1]["w1"] = W1;
                                                    dt_errors.Rows[dt_errors.Rows.Count - 1]["Error"] = "Xray# mismatch with DJ#";
                                                    string x = "";
                                                    if (Wgen_main_form.dt_all_points.Rows[i][col3] != DBNull.Value)
                                                    {
                                                        x = Convert.ToString(Wgen_main_form.dt_all_points.Rows[i][col3]);
                                    ...
                                    dataset1.Relations.Remove(relation_mm_back);
                                    dataset1.Relations.Remove(relation_mm_ahead);
                                ...
                                for (int i = 0; i < Wgen_main_form.dt_all_points.Rows.Count; ++i)
                                {
                                    ...
                                    if (Wgen_main_form.dt_all_points.Rows[i][col_fc] != DBNull.Value)
                                    {
                                        feature_code = Convert.ToString(Wgen_main_form.dt_all_points.Rows[i][col_fc]);
                                    }
                                    ...
                                    #region bend checks
                                    if (Wgen_main_form.dt_all_points.Rows[i][col_fc] != DBNull.Value && Convert.ToString(Wgen_main_form.dt_all_points.Rows[i][col_fc]).ToUpper() == "BEND")
                                    {
                                        if (Wgen_main_form.lista_feature_code_exception == null ||
                                            Wgen_main_form.lista_feature_code_exception.Count == 0 ||
                                            Wgen_main_form.lista_feature_code_exception.Contains(Convert.ToString(Wgen_main_form.dt_all_points.Rows[i][col_fc])) == false)
                                    ...
                                    #region elbow checks
                                    if (Wgen_main_form.dt_all_points.Rows[i][col_fc] != DBNull.Value && Convert.ToString(Wgen_main_form.dt_all_points.Rows[i][col_fc]).ToUpper() == "ELBOW")
                                    {
                                        if (Wgen_main_form.lista_feature_code_exception == null ||
                                            Wgen_main_form.lista_feature_code_exception.Count == 0 ||
                                            Wgen_main_form.lista_feature_code_exception.Contains(Convert.ToString(Wgen_main_form.dt_all_points.Rows[i][col_fc])) == false)
                                ...
                                Wgen_main_form.dt_all_points.Columns.Add("Cover", typeof(double));
                                double ng_tolerance = 100;
                                for (int i = 0; i < Wgen_main_form.dt_all_points.Rows.Count; ++i)
                                {
                                    if (Wgen_main_form.dt_all_points.Rows[i][col_fc] != DBNull.Value && 
                                        Wgen_main_form.dt_all_points.Rows[i][col2] != DBNull.Value && Wgen_main_form.dt_all_points.Rows[i][col3] != DBNull.Value && Wgen_main_form.dt_all_points.Rows[i][col4] != DBNull.Value)
                                    {
                                        string feature_code1 = Convert.ToString(Wgen_main_form.dt_all_points.Rows[i][col_fc]);
                                        double x1 = Convert.ToDouble(Wgen_main_form.dt_all_points.Rows[i][col3]);
                                        double y1 = Convert.ToDouble(Wgen_main_form.dt_all_points.Rows[i][col2]);
                                        double z1 = Convert.ToDouble(Wgen_main_form.dt_all_points.Rows[i][col4]);

                                        if (feature_code1.ToUpper() == "WELD" || feature_code1.ToUpper() == "BEND")
                                        {
                                            double d_max = ng_tolerance;
                                            for (int j = 0; j < Wgen_main_form.dt_all_points.Rows.Count; ++j)
                                            {
                                                if (Wgen_main_form.dt_all_points.Rows[j][col_fc] != DBNull.Value)
                                                {
                                                    if (i != j && Wgen_main_form.dt_all_points.Rows[j][col_fc] != DBNull.Value)
                                                    {
                                                        string feature_code2 = Convert.ToString(Wgen_main_form.dt_all_points.Rows[j][col_fc]);
                                                        if (feature_code2.ToUpper() == "NATURAL_GROUND")
                                                        {
                                                            if (Wgen_main_form.dt_all_points.Rows[j][col2] != DBNull.Value && Wgen_main_form.dt_all_points.Rows[j][col3] != DBNull.Value && Wgen_main_form.dt_all_points.Rows[j][col4] != DBNull.Value)
                                                            {
                                                                double x2 = Convert.ToDouble(Wgen_main_form.dt_all_points.Rows[j][col3]);
                                                                double y2 = Convert.ToDouble(Wgen_main_form.dt_all_points.Rows[j][col2]);
                                                                double z2 = Convert.ToDouble(Wgen_main_form.dt_all_points.Rows[j][col4]);

                                                                double d2 = Math.Pow(Math.Pow(x1 - x2, 2) + Math.Pow(y1 - y2, 2), 0.5);

                                                                if (d2 < d_max)
                                                                {
                                                                    d_max = d2;
                                                                    Wgen_main_form.dt_all_points.Rows[i]["Cover"] = z2 - z1;
                                                                }
                                                            }
                                                        }
                                                    }
        ...
        private void button_refresh_ws1_Click(object sender, EventArgs e)
        {
            ...
            if (comboBox_ws1.Items.Count > 0)
            {
                ...
                {
                    if (comboBox_ws1.Items[i].ToString().ToUpper().Contains("ASBUILT_POINTS") == true || comboBox_ws1.Items[i].ToString().ToUpper().Contains("ALL_POINTS") == true)
                    {
        ...
        private void button_load_features_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                forma2.set_checkbox_total_length(Wgen_main_form.dj_total_length);
                forma2.set_checkbox_pmc_as_cc(Wgen_main_form.use_pmc_as_cc);
            }
            catch (System.Exception EX)
            {
                MessageBox.Show(EX.Message);
        ...
        public void radioButton_all_points_CheckedChanged(RadioButton radioButton_enlarged)
        {
            ...
            if (radioButton_enlarged.Checked == true)
            {
                button_extra_checks.Location = new Point(696, 2);
                button_extra_checks.Size = new Size(25, 25);

            }
            else
            {
                button_extra_checks.Location = new Point(699, 2);
                button_extra_checks.Size = new Size(21, 21);
        ...
        private void button_extra_checks_Click(object sender, EventArgs e)
        {
            Wgen_extra_checks.X = this.MdiParent.Location.X + 650;
            Wgen_extra_checks.Y = this.MdiParent.Location.Y + 140;
            Form extra1 = new Wgen_extra_checks();
            extra1.ShowDialog();
        }
    }
}
