...
namespace Alignment_mdi
{
    public partial class Wgen_weldmap : Form
    {
        ...
        public DialogResult InputBox(string title, string promptText)
        {
            ...
            inputbox1.Controls.AddRange(new Control[] { label1,  buttonOK, Panel1 });
        ...
        private void button_create_weldmap_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                Wgen_main_form.dt_all_points = Functions.Sort_data_table(Wgen_main_form.dt_all_points, colpt27);
                ...
                for (i = 0; i < Wgen_main_form.dt_all_points.Rows.Count; ++i)
                {
                    if (Wgen_main_form.dt_all_points.Rows[i][colpt1] != DBNull.Value &&
                        Wgen_main_form.dt_all_points.Rows[i][colpt5] != DBNull.Value &&
                        Wgen_main_form.dt_all_points.Rows[i][colpt27] != DBNull.Value &&
                        Functions.IsNumeric(Convert.ToString(Wgen_main_form.dt_all_points.Rows[i][colpt27]).Replace("+", "")) == true &&
                        Wgen_main_form.dt_all_points.Rows[i][colpt2] != DBNull.Value &&
                        Functions.IsNumeric(Convert.ToString(Wgen_main_form.dt_all_points.Rows[i][colpt2])) == true &&
                        Wgen_main_form.dt_all_points.Rows[i][colpt3] != DBNull.Value &&
                        Functions.IsNumeric(Convert.ToString(Wgen_main_form.dt_all_points.Rows[i][colpt3])) == true &&
                ...
                if (string1.Contains("[") == true && string1.Contains("]") == true)
                {
                  string   filename = string1.Substring(string1.IndexOf("]") + 4, string1.Length - (string1.IndexOf("]") + 4));
                    ...
                    if (filename.Length > 0 && sheet_name.Length > 0)
                    {
                        ...
                        if (W2 != null)
                        {
                            Wgen_main_form.dt_weld_map = Functions.Populate_data_table_from_excel(Wgen_main_form.dt_weld_map, W2, start_row, textBox_1.Text, textBox_2.Text, textBox_3.Text, textBox_4.Text, textBox_5.Text, textBox_6.Text, textBox_7.Text, textBox_8.Text, textBox_9.Text, textBox_10.Text, textBox_11.Text,
                                 "", "", "", "", "", "", "", "", "", "", "", "", "", "","", true);
                            if (Wgen_main_form.dt_weld_map.Rows.Count > 0)
                            {
                                Wgen_main_form.tpage_weldmap.Hide();
        ...
        public void radioButton_weldmap_CheckChanged(RadioButton radioButton_enlarged)
        {
            ...
            if (radioButton_enlarged.Checked == true)
            {
                button_create_weldmap.Location = new Point(3, 35);
            ...
            {
                button_create_weldmap.Location = new Point(3, 31);
            ...
            if (radioButton_enlarged.Checked == true)
            {
                panel_pipe_manifest.Location = new Point(3, 68);
                panel_pipe_manifest.Size = new Size(723, 35);
            }
            else
            {
                panel_pipe_manifest.Location = new Point(3, 63);
                panel_pipe_manifest.Size = new Size(723, 33);
            }

            if (radioButton_enlarged.Checked == true)
            {
                button_wm_l.Location = new Point(695, 3);
                button_wm_l.Size = new Size(24, 24);
            }
            else
            {
                button_wm_l.Location = new Point(697, 5);
                button_wm_l.Size = new Size(21, 21);
            }

            if (radioButton_enlarged.Checked == true)
            {
                button_wm_nl.Location = new Point(695, 3);
                button_wm_nl.Size = new Size(24, 24);
            }
            else
            {
                button_wm_nl.Location = new Point(697, 5);
            ...
            if (radioButton_enlarged.Checked == true)
            {
                button_load_weld_map.Location = new Point(494, 2);
            ...
            {
                button_load_weld_map.Location = new Point(502, 2);
            ...
            if (radioButton_enlarged.Checked == true)
            {
                dataGridView_error_weld_map.Location = new Point(3, 134);
            ...
            {
                dataGridView_error_weld_map.Location = new Point(3, 126);
            ...
            {
                panel_stats.Location = new Point(3, 555);
            ...
            if (radioButton_enlarged.Checked == true)
            {
                textBox_PM_Items.Location = new Point(3, 25);
            ...
            if (radioButton_enlarged.Checked == true)
            {
                textBox_PM_no_rows.Location = new Point(315, 25);
            ...
            if (radioButton_enlarged.Checked == true)
            {
                textBox_PM_missing_OD.Location = new Point(3, 51);
            ...
            if (radioButton_enlarged.Checked == true)
            {
                textBox_PM_no_duplicates.Location = new Point(315, 51);
            ...
            if (radioButton_enlarged.Checked == true)
            {
                textBox_WM_defl_issues.Location = new Point(3, 77);
            ...
            {
                textBox_WM_defl_issues.Location = new Point(3, 63);
            ...
            if (radioButton_enlarged.Checked == true)
            {
                textBox_WM_no_defl.Location = new Point(315, 77);
            ...
            {
                textBox_WM_no_defl.Location = new Point(311, 63);
            ...
            if (radioButton_enlarged.Checked == true)
            {
                textBox_WM_null_value_items.Location = new Point(3, 103);
            ...
            {
                textBox_WM_null_value_items.Location = new Point(3, 84);
            ...
            if (radioButton_enlarged.Checked == true)
            {
                textBox_WM_no_null.Location = new Point(315, 103);
            ...
            {
                textBox_WM_no_null.Location = new Point(311, 84);
            ...
            if (radioButton_enlarged.Checked == true)
            {
                button_pipe_rep.Location = new Point(503, 3);
            ...
            {
                button_pipe_rep.Location = new Point(556, 3);
            ...
            if (radioButton_enlarged.Checked == true)
            {
                button_export_errors_to_xl.Location = new Point(503, 96);
            ...
            {
                button_export_errors_to_xl.Location = new Point(556, 80);
