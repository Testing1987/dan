...
namespace Alignment_mdi
{
    ...
    class BlockJig : EntityJig
    {
        ...
        public BlockJig(Transaction tr, BlockReference br, Dictionary<ObjectId, AttInfo> attInfo, Polyline poly2d) : base(br)
        {
            _poly2d = poly2d;
            _pos = br.Position;
            _attInfo = attInfo;
...

    {
        ...
        static public void BlockJigCmd()
        {
            ...
            using (trans1)
            {
                ...
                // Run the jig
                BlockJig myJig = new BlockJig(trans1, br, attInfo, null);
